...
presage presage_new (_presage_callback_get_past_stream past,
		     _presage_callback_get_future_stream future)
{
    presage prsg = (presage) malloc (sizeof (_presage));
...
char* presage_completion (presage prsg, const char* token)
{
...
char* presage_config (presage prsg, const char* variable)
{
    return alloc_c_str (prsg->presage_object->config (variable));
}

void presage_config_set (presage prsg, const char* variable, const char* value)
{
