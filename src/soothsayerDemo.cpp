...
void drawPreviousSuggestions(std::vector<std::string>);
...
int main()
{
    ...
    WINDOW* historyWin = newwin( 5, COLS, 3, 0 );
...
void drawPreviousSuggestions(std::vector<std::string> words)
{
